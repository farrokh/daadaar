    ...
    <div className="space-y-12">
        ...
        <div className="md:col-span-8 space-y-6">
          ...
          <div className="space-y-4 pt-4">
            ...
            <ul className="list-disc pl-5 space-y-2 text-lg leading-relaxed text-foreground/80 font-light">
              <li>
                <strong className="font-medium text-foreground">{t('ugc_share_title')}</strong>{' '}
                {t('ugc_share_body')}
              </li>
              <li>
                <strong className="font-medium text-foreground">{t('ugc_adapt_title')}</strong>{' '}
                {t('ugc_adapt_body')}
              </li>
            </ul>
          </div>
            ...
            <ul className="list-disc pl-5 space-y-2 text-lg leading-relaxed text-foreground/80 font-light">
              <li>
                <strong className="font-medium text-foreground">
                  {t('ugc_attribution_title')}
                </strong>{' '}
                {t('ugc_attribution_body')}
              </li>
              <li>
                <strong className="font-medium text-foreground">{t('ugc_sharealike_title')}</strong>{' '}
                {t('ugc_sharealike_body')}
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 border-t border-foreground/10 pt-12">
        ...
        <div className="md:col-span-8 space-y-8">
          <p className="text-lg leading-relaxed text-foreground/80 font-light">{t('dmca_intro')}</p>
          <p className="text-lg leading-relaxed text-foreground/80 font-light">
            {t('dmca_instruction')}
          </p>
