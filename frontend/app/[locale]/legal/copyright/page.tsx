...
export default function CopyrightPage() {
  return (
    <div>
      ...
      <p>
        By submitting text, images, or other media to Daadaar, you agree to license your
      ...
      <p>This means that others are free to:</p>
      <ul>
        <li>
      ...
      <ul>
        <li>
          <strong>Attribution:</strong> You must give appropriate credit to Daadaar and the original
          author (if known).
        </li>
        <li>
      ...
      <p>
        Daadaar respects the intellectual property rights of others. It is our policy to respond to
      ...
      <p>
        ...
        submit your claim via email or our reporting tool, with the subject line: "Copyright
      ...
      <ol>
        ...
        <li>
          Description of the material that is claimed to be infringing and where it is located on
          the Service.
        </li>
      ...
      <p>
        Some content on the platform may be sourced from public domain records or other openly
        licensed sources. We strive to attribute these sources correctly.
      </p>
    </div>
  );
}
