...
export const ReportCard: React.FC<ReportCardProps> = ({ report }) => {
  ...
  const previewImage = report.media?.find(m => m.mediaType === 'image') as any;
  const imageUrl = previewImage ? (previewImage.url || getS3PublicUrl(previewImage.s3Key, previewImage.s3Bucket)) : null;
